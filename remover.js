censoredSrc = ["https://static.xx.fbcdn.net/images/emoji.php/v9/te3/1.5/32/1f602.png",
...
censoredBg = ['url("https://static.xx.fbcdn.net/images/emoji.php/v9/t29/1.5/16/1f602.png")', 'url("https://www.facebook.com/images/emoji.php/v9/tdc/1.5/16/1f60e.png")',
...
monitor = new MutationObserver(function (mutations, observer) {
	...
	spans = ["_6qdm", "_3gl1", "_21wj", "_1ift", "_1ifu", "_5zft", "_19_s"]
	emoji = []
		...
		for (i = 0; i < emoji.length; i++) {
			if (emoji[i].tagName == "IMG") {
				if (censoredSrc.includes(emoji[i].src)) {
					emoji[i].src = "https://cdn.worldvectorlogo.com/logos/adobe-xd.svg";
				}
			} else {
				if (censoredBg.includes(emoji[i].style.backgroundImage)) {
					emoji[i].style.backgroundImage = 'url("https://cdn.worldvectorlogo.com/logos/adobe-xd.svg")'
				}
			}
		}
	}
